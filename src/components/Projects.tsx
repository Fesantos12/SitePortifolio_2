...
export const Projects = () => {
  return (
    <div className="w-full h-screen px-6.5 py-9 flex flex-col items-center justify-between bg-gray-300">
      ...
      <BlurFade className="w-full flex flex-col items-center">
        <div className="w-full h-56 bg-gray-400 rounded-2xl">
          <img
        ...
        <div className="w-full flex flex-col items-start gap-4 mt-4">
          ...
          <div className="text-sm">
            ...
            sit amet vestibulum felis vivamus facilisis ligula
          </div>
      ...
      <BlurFade className="w-full flex flex-col gap-10">
