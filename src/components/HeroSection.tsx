  ...
  return (
    <section className="w-full h-[calc(100vh-90px)] px-6.5 py-9 flex flex-col items-center justify-center gap-20">
        ...
        <div className="w-full flex flex-col items-center gap-2">
            <TypingAnimation className="text-4xl font-bold" loop>Hi, I’m Fellipe Santos</TypingAnimation>
            <div className="text-[20px] font-light">I'm Full-Stack Developer</div>
        </div>
